            ...
            <div className="block m-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className="items-center m-5 pb-10 pt-10">
                    ...
                    <table className="min-w-full text-left text-sm font-light">
                            <thead className="border-b font-medium wh:border-neutral-500 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                            ...
                            <tbody>
                                {inbounds.map((inbound, id) => (
                                    <tr key={inbound.id} className="border-b dark:border-neutral-500">
                                        ...
                                        <a href={"http://localhost:8000/uploads/" + inbound.proff_file} target="_blank" rel="noopener noreferrer">
                                        <img src={"http://localhost:8000/uploads/" + inbound.proff_file} alt="profile" />
    </a>
</td>
